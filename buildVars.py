...
Define voices in NVDA settings, then use NVDA + Alt + V anytime to toggle to the next voice."""),
	...
	"addon_url": "https://github.com/adamsamec/VoiceToggle",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/adamsamec/VoiceToggle",
	...
	"addon_licenseURL": "https://www.gnu.org/licenses/",
}
...
pythonSources = ["addon/globalPlugins/voiceToggle/*.py"]
